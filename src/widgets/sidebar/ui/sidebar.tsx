...
import { FaChevronDown, FaChevronUp, FaClipboardList, FaCommentDots } from 'react-icons/fa'
...
const SideBar: React.FC = () => {
    ...
    return (
        <aside className='fixed w-[250px] h-[calc(100vh-40px)] bg-main-blue rounded-2xl '>
